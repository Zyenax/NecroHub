...
public class ScoreBoardHandler implements Listener{
	...
	public ScoreBoardHandler(NecroHub listener) {
    ...
    public static void makeScoreBoard(Player p){
        ...
        objective.setDisplayName(Utils.color(NecroCore.name));
        		...
        		public void run() {
        			...
        			for(final Player p : Bukkit.getOnlinePlayers()){
        				if(!(p.equals(null))){
            				...
            				team1.setPrefix(Utils.color("&cServers:"));
            				...
            				team7.setPrefix(Utils.color("&cMCRiot.net"));
            				team7.setSuffix(Utils.color(""));
    				
            				/*Team team8 = p.getScoreboard().getTeam("team8");
            				team8.setPrefix(Utils.color("&cMCRiot.net"));
